...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 98982333330</li>	
					<li class="s-bar">
						<div class="search">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#Mealplans" class="menu__link scroll">Meal Plans</a></li> 
							<li class="menu__item"><a href="#contact" class="menu__link scroll">Contact Us</a></li>
							<li class="menu__item"><a href="admin/home.php" class="">Admin login</a></li>
						</ul>
					</nav>
				</div>
			</nav>
...
<div class="col-md-12 book-form-left-w3layouts" class="about-wthree" id="Mealplans">
<font background color="red">	<a href="admin/mealplans.php"><h2>Meal Plans</h2></font></a>
</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Make your bookings directly with us for the most seamless experience and the best value. With compelling exclusive offers</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Address :</strong> Sarola Baddi,Jamkhed Road 
Ahmednagar -414201
Maharashtra,India</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.5495069436347!2d74.7605648504148!3d19.08353455663142!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdcb040bbbe9f07%3A0x64264c82564309b9!2sJamkhed%20Rd%2C%20Ahmednagar%2C%20Maharashtra%20414002!5e0!3m2!1sen!2sin!4v1579154917536!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
